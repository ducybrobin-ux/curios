/* game-flow.js — Logique de jeu pure, extraite de app.js.
 *
 * Fonctions pures testables en Node.js. Aucune dépendance DOM.
 * Toutes les dépendances (Store, AudioSys, BALISES, etc.) sont
 * injectées via un objet `ctx`.
 *
 * Expose window.GameFlow pour usage dans app.js.
 */
(function () {
  "use strict";
